...
export const TileMatchTutorialScreen: React.FC<TileMatchTutorialScreenProps> = ({onComplete}) => {
  ...
  const steps = [
    {icon: '🧩', title: t.tmTutWelcomeTitle, body: t.tmTutWelcomeBody},
    {icon: '📦', title: t.tmTutLayersTitle, body: t.tmTutLayersBody},
    {icon: '📊', title: t.tmTutBarTitle, body: t.tmTutBarBody},
    {icon: '🎮', title: t.tmTutReadyTitle, body: t.tmTutReadyBody},
  ];
